...
bool GribSection5::parseFile(std::FILE* file)
{
	...
	auto data_representation_template_number = convertBytesToUint16(&buffer[9], 2);
	...
	auto type_of_original_field_values = convertBytesToUint8(&buffer[20]);
	type_of_original_field_values_.setLong(type_of_original_field_values);
	auto type_of_compression_used = convertBytesToUint8(&buffer[21]);
